...
public class HomeFragment extends Fragment {
    ...
    private void initComponents(View root) {
        ...
        categoryHelpers.add(new CategoryHelper(R.drawable.bike_sports, "1", "Sports", gradientDrawables[0]));
        categoryHelpers.add(new CategoryHelper(R.drawable.bike_luxury, "2", "Touring", gradientDrawables[1]));
        categoryHelpers.add(new CategoryHelper(R.drawable.scooter, "3", "Scooter", gradientDrawables[2]));
        categoryHelpers.add(new CategoryHelper(R.drawable.ev, "4", "EV", gradientDrawables[3]));
        ...
        Car.getAvailableCars(new CarDao() {
            ...
            public void getCarList(List<Car> carList) {
                if (carList != null && carList.size() > 0) {
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "No Available Bikes", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
