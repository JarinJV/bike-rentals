...
public class Booking {
    ...
    public Booking(String id, String providerId, String receiverId, String carId, long from, long until, String status, int rentPerDay, float totalFare) {
        this.id = id;
...
//        totalFare = days * rentPerDay;
    ...
    public static void getBookingByStatus(String status, BookingDao bookingDao) {
        databaseReference.orderByChild("status").equalTo(status).addListenerForSingleValueEvent(getBookingListListener(bookingDao));
    }
    public static void getBookingByStatusReceiver(String status, String receiverId, BookingDao bookingDao) {
        databaseReference.orderByChild("status").equalTo(status).addListenerForSingleValueEvent(getBookingListListener(bookingDao));;
    }
    ...
    public static void getBooking(BookingDao bookingDao) {
        databaseReference.addListenerForSingleValueEvent(getBookingListListener(bookingDao));
    }
